...
DM: {
	data: {}
	text: json.Indent(json.Marshal(DM.data), "", "  ") + "\n"
}
...
DM: pretext: """
	...
	FIELD-TYPES: [string, int, bool, float, uuid, datetime, email, password, url]
	RELATION-TYPES: [belongs-to, has-one, has-many, many-to-many]
